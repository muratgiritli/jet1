  ...
  return (
    <div className="min-h-screen flex flex-col bg-background pb-16 md:pb-0">
      ...
      <main className="flex-1 max-w-lg mx-auto w-full">
        ...
        <section className="px-3 pt-2 pb-2" data-testid="section-campaign-banner">
          <Link href="/kampanya">
            <div
              className="rounded-lg px-3 py-2 flex items-center gap-2.5 cursor-pointer border border-purple-200/60 backdrop-blur-sm transition-all active:scale-[0.98]"
              style={{ background: "linear-gradient(90deg, #6B3480 0%, #8e44ad 100%)" }}
              data-testid="banner-campaign"
            >
              <Tag className="w-4 h-4 text-white/90 flex-shrink-0" />
              <span className="text-white text-xs font-bold tracking-wide flex-1">Kampanyalı Ürünler</span>
              <span className="text-[10px] text-white/70 font-medium hidden sm:inline">Fırsatları Keşfet</span>
              <ArrowRight className="w-3.5 h-3.5 text-white/80 flex-shrink-0" />
            </div>
          </Link>
        </section>
