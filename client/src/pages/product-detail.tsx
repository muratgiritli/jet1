...
const ANIMAL_SUBCATEGORIES: Record<string, SubcategoryInfo[]> = {
  ...
  kedi: [
    ...
    { name: "Kedi Kumu", slug: "kedi-kumu", staticCategory: "KEDİ KUMU" },
    { name: "Kedi Malti", slug: "kedi-malti", staticCategory: "KEDİ MALT" },
    { name: "Kedi Odulleri", slug: "kedi-odulu", staticCategory: "KEDİ ÖDÜLLERİ" },
    ...
    { name: "Kedi Yas Mamasi", slug: "kedi-konserve", hasBrands: true },
    { name: "Uygun Cuval Mamalar", slug: "uygun-cuval", staticCategory: "KEDİ UYGUN ÇUVAL" },
  ],
  kus: [
