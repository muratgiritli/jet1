...
- [Visitor tracking geo](visitor-tracking.md) — ip-api free tier is http-only (don't force https); use req.ip not raw XFF; daily filter must be a sargable UTC range.
