    ...
    <div className="min-h-screen bg-[#f5f4fb] flex justify-center font-['Inter']">
      <div className="w-full max-w-[412px] bg-white pb-4">
        ...
        <div className="px-3 mt-4 grid grid-cols-6 gap-1.5">
          <CatCircle img="/__mockup/images/category-dog.webp" label="Köpek" ring="ring-orange-300" />
          <CatCircle img="/__mockup/images/category-cat.webp" label="Kedi" ring="ring-purple-300" />
          <CatCircle img="/__mockup/images/category-bird.webp" label="Kuş" ring="ring-sky-300" />
          <CatCircle img="/__mockup/images/category-rabbit.webp" label="Kemirgen" ring="ring-pink-300" />
          <CatCircle img="/__mockup/images/cat-bird.webp" label="Akvaryum" ring="ring-orange-400" />
