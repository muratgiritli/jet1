    ...
    <div className="min-h-screen bg-white max-w-md mx-auto text-slate-800 shadow-xl overflow-x-hidden relative pb-10">
      ...
      <section className="relative px-4 pt-6 pb-12 bg-gradient-to-br from-orange-50 via-amber-100/50 to-white overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <button className="w-full bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold text-lg py-4 rounded-2xl shadow-lg shadow-orange-500/40 transform hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2">
            Hemen Sipariş Ver
      ...
      {/* VALUE PROPOSITION STRIP (HORIZONTAL SCROLL) */}
      ...
      <footer className="border-t border-slate-100 pt-8 pb-4 px-4 text-center">
        <div className="flex items-center justify-center gap-2 mb-4 text-emerald-600 bg-emerald-50 py-2 px-4 rounded-full inline-flex mx-auto">
      ...
      {/* STICKY BOTTOM CTA */}
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/90 backdrop-blur-md border-t border-slate-100 z-50 transform translate-y-0 transition-transform">
        <div className="max-w-md mx-auto">
          <button className="w-full bg-slate-900 text-white font-bold text-base py-3.5 rounded-xl shadow-lg flex items-center justify-center gap-2">
