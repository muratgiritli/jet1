    ...
    <div className="min-h-screen bg-[#f4f3fb] flex justify-center font-['Inter']">
      <div className="w-full max-w-[412px] bg-white">
        ...
        <div className="px-3 mt-2 grid grid-cols-4 gap-2">
          <CategoryCard label="Köpek" img="/__mockup/images/category-dog.webp" ring="ring-orange-300" badge="bg-orange-500" />
          <CategoryCard label="Kedi" img="/__mockup/images/category-cat.webp" ring="ring-purple-300" badge="bg-purple-500" />
          <CategoryCard label="Kuş" img="/__mockup/images/category-bird.webp" ring="ring-yellow-300" badge="bg-yellow-500" />
          <CategoryCard label="Kemirgen" img="/__mockup/images/category-rabbit.webp" ring="ring-emerald-300" badge="bg-emerald-500" />
        </div>
