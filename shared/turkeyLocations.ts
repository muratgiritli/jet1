// AUTO-GENERATED Türkiye il/ilçe verisi (kargo adres seçimi için).
  // Kaynak: github.com/snrylmz/il-ilce-json. Elle düzenlemeyin.
  ...
  export const PROVINCE_NAMES: string[] = TURKEY_PROVINCES.map((p) => p.name);
